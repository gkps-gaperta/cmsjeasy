...
class Excel{
    ...
    $excel = new Excel();
    #Send Header
    $excel->setHeader("dataparameter.xls");
    $excel->BOF();
    //$excel->cleanData();
    ...
    $excel->writelabel(0, 1, "parameterid"); 
    $excel->writelabel(0, 2, "parametertext"); 
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 1,$row->parameterid); 
        $excel->writelabel($i, 2,$row->parametertext); 
