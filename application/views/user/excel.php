...
class Excel{
    ...
    $excel->writelabel(0, 37, "photofile"); 
    $excel->writelabel(0, 38, "modifiedby"); 
    $excel->writelabel(0, 39, "modifiedon");
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 37,$row->photofile); 
        $excel->writelabel($i, 38,$row->modifiedby); 
        $excel->writelabel($i, 39,$row->modifiedon);
