...
class Excel{
    ...
    $excel->writelabel(0, 1, "rayonid"); 
    $excel->writelabel(0, 2, "rayonname"); 
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 1,$row->rayonid); 
        $excel->writelabel($i, 2,$row->rayonname); 
