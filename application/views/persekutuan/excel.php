...
class Excel{
    ...
    $excel = new Excel();
    #Send Header
    $excel->setHeader("datapersekutuan.xls");
    $excel->BOF();
    //$excel->cleanData();
    ...
    $excel->writelabel(0, 1, "persekutuanid"); 
    $excel->writelabel(0, 2, "persekutuanname"); 
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 1,$row->persekutuanid); 
        $excel->writelabel($i, 2,$row->persekutuanname); 
