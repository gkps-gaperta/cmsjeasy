...
class Excel{
    ...
    $excel->writelabel(0, 1, "bloodid"); 
    $excel->writelabel(0, 2, "bloodname"); 
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 1,$row->bloodid); 
        $excel->writelabel($i, 2,$row->bloodname); 
