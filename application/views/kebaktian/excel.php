...
class Excel{
    ...
    $excel = new Excel();
    #Send Header
    $excel->setHeader("datakebaktian.xls");
    $excel->BOF();
    //$excel->cleanData();
    ...
    $excel->writelabel(0, 1, "kebaktianid"); 
    $excel->writelabel(0, 2, "kebaktianname"); 
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 1,$row->kebaktianid); 
        $excel->writelabel($i, 2,$row->kebaktianname); 
