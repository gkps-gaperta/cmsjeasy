...
class Excel{
    ...
    $excel = new Excel();
    #Send Header
    $excel->setHeader("datapstatus.xls");
    $excel->BOF();
    //$excel->cleanData();
    ...
    $excel->writelabel(0, 1, "pstatusid"); 
    $excel->writelabel(0, 2, "pstatusname"); 
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 1,$row->pstatusid); 
        $excel->writelabel($i, 2,$row->pstatusname); 
