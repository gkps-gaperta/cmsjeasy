...
<table class="table table-condensed" border="0" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td rowspan="37" valign="top" align="center">
			...
			<a href="<?php echo base_url()?>tb/download/<?php echo $url ?>" title="Download Foto">
	...
	<tr>
		...
		<td>: 
			<script type="text/javascript">
				$(document).ready(function(){
					$("#tgl_hadir").datepicker({dateFormat: 'dd-mm-yy'});
				});
			</script>
			<input type="text" class="inputmedium" value="<?php echo @$row['tgl_hadir'] ?>" name="tgl_hadir" id="tgl_hadir">
        </td>
	</tr>
	<tr>
		<td>memberno</td>
...
<!--
		<td>statusid</td>
		<td>: <input type="text" class="inputmedium" value="abc" name="statusid" id="statusid"></td>


		<td>statusid</td>
		<td>: 
			<select id="statusid" name="statusid" >
                <option value="" selected="selected">TEMAN BARU</option>
                <?php
