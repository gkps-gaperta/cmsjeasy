...
class Excel{
    ...
    $excel = new Excel();
    #Send Header
    $excel->setHeader("dataserving.xls");
    $excel->BOF();
    //$excel->cleanData();
    ...
    $excel->writelabel(0, 1, "servingid"); 
    $excel->writelabel(0, 2, "servingname"); 
    ...
    foreach ($sql->result() as $row){
        ...
        $excel->writelabel($i, 1,$row->servingid); 
        $excel->writelabel($i, 2,$row->servingname); 
