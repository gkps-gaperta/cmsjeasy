...
<table class="table table-condensed" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>servingid</td>
		<td>: <input type="text" class="inputmedium" value="<?php echo @$row['servingid'] ?>" name="servingid" id="servingid"><span id="tip"></span></td>
	</tr>
	<tr>
		<td>servingname</td>
		<td>: <input type="text" class="inputmedium" value="<?php echo @$row['servingname'] ?>" name="servingname" id="servingname"><span id="tip"></span></td>
	</tr>
</table>